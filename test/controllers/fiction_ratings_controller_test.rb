...
class FictionRatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create fiction rating with valid rating' do
    ...
    verify_fiction_rating_summary_keys(json_response)
  end
  ...
  test 'should update existing fiction rating' do
    ...
    assert_equal [5, 5], [json_response['user_rating'], existing_rating.rating]
  end
  ...
  def verify_fiction_rating_summary_keys(json_response)
