...
set :default_env, {
  ...
  'OPENSEARCH_CA_CERT' => ENV.fetch('OPENSEARCH_CA_CERT'),
  'OPENSEARCH_OPEN_TIMEOUT' => ENV.fetch('OPENSEARCH_OPEN_TIMEOUT', '2'),
  'OPENSEARCH_PASSWORD' => ENV.fetch('OPENSEARCH_PASSWORD'),
  'OPENSEARCH_TIMEOUT' => ENV.fetch('OPENSEARCH_TIMEOUT', '60'),
