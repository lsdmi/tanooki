...
Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = ['https://baka.in.ua', %r{https://baka\.in\.ua.*}]
  ...
  # Durable job queue in MySQL (same DB as the app; see db/migrate/*_create_solid_queue_tables.rb).
  ...
  config.action_mailer.default_url_options = { host: 'baka.in.ua' }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address: 'smtp.zoho.com',
    port: 587,
    enable_starttls_auto: true,
    user_name: 'support@baka.in.ua',
