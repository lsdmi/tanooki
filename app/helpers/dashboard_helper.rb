...
module DashboardHelper
  ...
  def delete_icon
    content_tag(:div,
                class: 'group flex items-center justify-center w-9 h-9 rounded-xl bg-stone-100 hover:bg-red-100 transition-all') do
      content_tag(:svg, class: 'w-5 h-5 text-red-500 group-hover:text-red-700 transition-all', aria: { hidden: true },
                        xmlns: 'http://www.w3.org/2000/svg',
                        width: 24, height: 24,
                        fill: 'none',
                        viewBox: '0 0 24 24',
                        stroke: 'currentColor') do
        concat tag(:path, stroke_linecap: 'round', stroke_linejoin: 'round', stroke_width: '2',
