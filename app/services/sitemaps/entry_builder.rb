...
module Sitemaps
  # Builds absolute URL entries (loc + optional lastmod) for sitemap.xml: static hubs and indexed models.
  class EntryBuilder
    ...
    STATIC_URL_HELPERS = %i[
      ...
      translation_requests_url about_url friends_url rules_url privacy_url
    ].freeze
