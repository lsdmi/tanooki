...
# Solid Queue tables on the primary database (no separate queue DB).
class CreateSolidQueueTables < ActiveRecord::Migration[8.0]
  def change
    table_options = { charset: 'utf8mb4', collation: 'utf8mb4_general_ci' }

    create_table :solid_queue_blocked_executions, **table_options do |t|
    ...
    create_table :solid_queue_claimed_executions, **table_options do |t|
      t.bigint :job_id, null: false
      t.bigint :process_id
      t.datetime :created_at, null: false
    ...
    create_table :solid_queue_failed_executions, **table_options do |t|
      t.bigint :job_id, null: false
      t.text :error
      t.datetime :created_at, null: false
    ...
    create_table :solid_queue_jobs, **table_options do |t|
      t.string :queue_name, null: false
    ...
    create_table :solid_queue_pauses, **table_options do |t|
      t.string :queue_name, null: false
      t.datetime :created_at, null: false
      t.index :queue_name, name: 'index_solid_queue_pauses_on_queue_name', unique: true
    end

    create_table :solid_queue_processes, **table_options do |t|
    ...
    create_table :solid_queue_ready_executions, **table_options do |t|
      t.bigint :job_id, null: false
      t.string :queue_name, null: false
      t.integer :priority, default: 0, null: false
      t.datetime :created_at, null: false
    ...
    create_table :solid_queue_recurring_executions, **table_options do |t|
      t.bigint :job_id, null: false
    ...
    create_table :solid_queue_recurring_tasks, **table_options do |t|
    ...
    create_table :solid_queue_scheduled_executions, **table_options do |t|
      t.bigint :job_id, null: false
      t.string :queue_name, null: false
      t.integer :priority, default: 0, null: false
    ...
    create_table :solid_queue_semaphores, **table_options do |t|
      t.string :key, null: false
